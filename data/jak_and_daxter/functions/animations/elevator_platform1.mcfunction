...
data merge entity @e[limit=1,sort=nearest,type=minecraft:item_display,tag=jad.elevator_platform1] {start_interpolation:0,interpolation_duration:1}

data modify entity @e[limit=1,sort=nearest,type=minecraft:item_display,tag=jad.elevator_platform1] transformation.translation set from storage jad:temp_data platform_rotation.pos