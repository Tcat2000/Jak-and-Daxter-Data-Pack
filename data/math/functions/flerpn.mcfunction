...
execute if score mul math.temp_data matches ..0 run scoreboard players operation mul math.temp_data *= n1 math.temp_data
...
return run scoreboard players get x1 math.temp_data
